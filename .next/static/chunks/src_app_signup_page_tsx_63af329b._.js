(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_app_signup_page_tsx_63af329b._.js", {
...
function SignUpPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setIsLoading(true);
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$aws$2d$amplify$2f$auth$2f$dist$2f$esm$2f$providers$2f$cognito$2f$apis$2f$signUp$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["signUp"])({
                username: email,
                password,
                options: {
                    userAttributes: {
...
_s(SignUpPage, "BbhKrpR521CC3Nl7G/zOLF4Fj+Y=", false, function() {
    return [
